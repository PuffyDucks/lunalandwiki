Diodes are two-terminal and nonlinear circuit elements which only allow current to flow in one direction, implemented using [[EEC111/Notes/p-n Junction|p-n junctions]]. 
# Current/Voltage Models
## Ideal Model
Open circuit when $V_D<0$, and shorted when $V_D>0$.
![[EEC111/Notes/src/Pasted image 20250514135744.png]]
## Constant Voltage Model
Only passes current when $V_D>V_{D,ON}$. Typically $0.7V$ for silicon diodes.
![[EEC111/Notes/src/Pasted image 20250514135800.png]]
...
![[EEC111/Notes/src/Pasted image 20250514135816.png]]
**Solving for current and voltage** 
$I_D\cong I_se^{V_D/V_T} \text{ for } i \gg I_S$
$I_D=\dfrac{V_{DD}-V_D}{R}$
Solve iteratively
# Small Signal Model
![[EEC111/Notes/src/Pasted image 20250514141205.png]]
$r_d=\dfrac{V_T}{I_D}$
...
![[EEC111/Notes/src/Pasted image 20250514135836.png]]

**Half Wave With Capacitor**
![[EEC111/Notes/src/Pasted image 20250514135849.png]]
$V_{ripple}=\dfrac{V_{max}-V_{D,ON}}{R_LCf}$

**Full Wave Without Capacitor**
![[EEC111/Notes/src/Pasted image 20250514135903.png]]

**Full Wave With Capacitor**
![[EEC111/Notes/src/Pasted image 20250514135921.png]]
...
![[EEC111/Notes/src/Diode Limiter.svg|500]]
![[EEC111/Notes/src/Pasted image 20250514135932.png]]
## Voltage Regulator
...
![[EEC111/Notes/src/Pasted image 20250514135941.png]]
