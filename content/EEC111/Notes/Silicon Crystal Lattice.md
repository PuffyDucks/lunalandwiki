...
$n_i=BT^{3/2}e^{-E_g/2kT}\cong1.5\times10^{10}cm^{-3}$
$pn=n_i^2$
$B$ - material parameter ($7.3 \times 10^{15} cm^{-3}K^{-3/2}$ for Si)
$T$ - temperature in kelvin
$E_g$ - bandgap energy ($1.12 eV$ for Si), or minimum energy to break covalent bond and generate electron hole pair
$k$ - Boltzmann's constant ($8.62\times10^{-5}eV\cdot K^{-1}$)
